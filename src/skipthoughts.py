...
#-----------------------------------------------------------------------------#
path_to_models = '../embeddings/skipthoughts/'
path_to_tables = '../embeddings/skipthoughts/'
#-----------------------------------------------------------------------------#
...
def load_model(verbose=False):
    ...
    """
    # Load model options
    if verbose: print('Loading model parameters...')
    ...
    # Extractor functions
    if verbose: print('Compiling encoders...')
    ...
    # Tables
    if verbose: print('Loading tables...')
    utable, btable = load_tables()

    # Store everything we need in a dictionary
    if verbose: print('Packing up...')
    model = {}
